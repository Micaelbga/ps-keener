    ...
    <div class="container">
       <div class="row">
            <div class="col-4">
                ...
                <Form class="container-input" @submit="addAmount">
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        <label for="newAmount">Quantidade a adicionar:</label>
                    ...
                    <button class="btn btn-primary" :disabled="disableButton">Adicionar ao estoque</button>
    ...
    methods:{
        ...
        async addAmount(values){
            onAuthStateChanged(getAuth(),(user)=>{
                ...
                StoreService.updateItem(this.selectedItem._id, this.selectedItem.name, updateAmount, movedAmount,  true, email);
            })
        }
    },
    async created(){
